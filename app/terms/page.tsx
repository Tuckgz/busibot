  ...
  return (
    <div className="w-full flex justify-center p-10">
      <div className="w-full max-w-screen-md space-y-6">
        <Link
          href="/"
          className="flex items-center gap-2 text-[#47331f] hover:text-[#47331f] underline"
        >
        ...
        <ol className="list-decimal list-inside space-y-4">
          <li className="text-[#47331f]">
            <span className="font-semibold">Acceptance of Terms:</span> By
            accessing and using the AI chatbot Busibot - Legal Advice provided by Tuckgz,
          ...
          <li className="text-[#47331f]">
            ...
            or implied. Tuckgz makes no representations or warranties regarding
          ...
          <li className="text-[#47331f]">
            ...
            Tuckgz does not guarantee that the Chatbot will be available at all
          ...
          <li className="text-[#47331f]">
            ...
            the fullest extent permitted by applicable law, Tuckgz shall not be
            ...
            Tuckgz has been advised of the possibility of such damages.
          </li>
          <li className="text-[#47331f]">
            <span className="font-semibold">
          ...
          <li className="text-[#47331f]">
            ...
            decisions made based on its output. Tuckgz is not responsible for any
          ...
          <li className="text-[#47331f]">
            ...
            considered equivalent to public postings, and Tuckgz does not
          ...
          <li className="text-[#47331f]">
            ...
            indemnify, defend, and hold harmless Tuckgz from any claims,
            liabilities, damages, losses, and expenses, including reasonable
            legal fees, arising from your use of the Chatbot or violation of
            these Terms of Use.
          </li>
          <li className="text-[#47331f]">
            <span className="font-semibold">Modifications to Terms:</span> Tuckgz
          ...
          <li className="text-[#47331f]">
            ...
            contact Tuckgz at tuckr@unc.edu.
          </li>
        </ol>
      </div>
    </div>
